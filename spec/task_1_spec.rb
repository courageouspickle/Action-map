...
describe 'Representatives' do
    describe RepresentativesController, type: :controller do
        before :each do
            @representatives = [
                { name: 'rep1', ocdid: '123', title: 'AAA', city: 'Berkeley',
street: 'Dwight Way', state: 'CA', zip: '94720',
                  party: 'Democrats', photo: 'a' },
                { name: 'rep2', ocdid: '123', title: 'AAA', city: 'Berkeley',
street: 'Dwight Way', state: 'CA', zip: '94720',
                  party: 'Democrats', photo: 'a' },
                { name: 'rep3', ocdid: '123', title: 'AAA', city: 'Berkeley',
street: 'Dwight Way', state: 'CA', zip: '94720',
                  party: 'Democrats', photo: 'a' }
            ]
...
street: 'Dwight Way', state: 'CA', zip: '94720',
        ...
        def extract_address(address)
            ...
            address.each do |addr|
                address_temp += '\n' if address_temp != ''
                addr_temp = "#{addr.street}, #{addr.city}, #{addr.state}, #{addr.zip}"
