...
class Representative < ApplicationRecord
    ...
    def self.get_party(official)
        party = if official.party.nil? || official.party.blank? || official.party.empty?
                    ' '
                else
                    official.party
                end
    ...
    def self.get_photo(official)
        photo = if official.photo_url.nil? || official.photo_url.blank? || official.photo_url.empty?
                    ' '
                else
                    official.photo_url
                end
